/*
ESP32-BT2USB
Software for Espressif ESP32 (plain) for Bluetooth Classic and BLE HID keyboard to USB interfacing over I2C.
A second ESP32 with USB-OTG support is needed, running this software: https://github.com/acepe/esp32-I2C-receiver 
Based on esp32-BT2PS2 (https://github.com/Hamberthm/esp32-bt2ps2) by Humberto Möckel. Adapted by André Ackermann for I2C interface instead of PS2.
...
// HID report structure for keyboards
    ...
    void i2c_master_send_text(const hid_keyboard_report_t *report) 
    {
        ...
        ESP_LOGD(TAG, "Sending report");
        ESP_LOG_BUFFER_HEX_LEVEL(TAG, report, size, ESP_LOG_DEBUG);
